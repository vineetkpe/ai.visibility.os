...
| `job_type` | `VARCHAR(50)` | **NO** | *None* | Job classification slug (e.g., `crawl`, `scan`) |
...
| `action` | `VARCHAR(100)` | **NO** | *None* | Action identifier (e.g., `user.login`, `scan.trigger`) |
...
| `report_type` | `VARCHAR(100)` | **NO** | *None* | Report type slug (e.g., `visibility_summary`) |
