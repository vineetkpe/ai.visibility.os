...
| :---------------- | :------------- | :------- | :------------------ | :---------------------------------- |
| `id`              | `UUID`         | **NO**   | `gen_random_uuid()` | Primary Key                         |
| `project_id`      | `UUID`         | **NO**   | _None_              | Composite Foreign Key component     |
| `domain_id`       | `UUID`         | **NO**   | _None_              | Composite Foreign Key component     |
| `url`             | `TEXT`         | **NO**   | _None_              | Full target URL                     |
| `path`            | `TEXT`         | **NO**   | _None_              | URL path component                  |
...
| :----------------- | :------------ | :------- | :------------------ | :-------------------------------------- |
| `id`               | `UUID`        | **NO**   | `gen_random_uuid()` | Primary Key                             |
| `page_id`          | `UUID`        | **NO**   | _None_              | Foreign Key to `public.pages(id)` (1:1) |
...
| :-------------- | :------------ | :------- | :------------------ | :---------------------------------------- |
| `id`            | `UUID`        | **NO**   | `gen_random_uuid()` | Primary Key                               |
| `domain_id`     | `UUID`        | **NO**   | _None_              | Foreign Key to `public.domains(id)` (1:1) |
...
_Note: Updated in place upon refetch (not historical)._
...
| `url`             | `TEXT`        | **NO**   | _None_              | Full sitemap URL                    |
...
| :----------------- | :------------ | :------- | :------------------ | :----------------------------------------- |
| `id`               | `UUID`        | **NO**   | `gen_random_uuid()` | Primary Key                                |
| `crawl_session_id` | `UUID`        | **NO**   | _None_              | Foreign Key to `public.crawl_sessions(id)` |
| `page_id`          | `UUID`        | YES      | `NULL`              | Optional Foreign Key to `public.pages(id)` |
| `url`              | `TEXT`        | **NO**   | _None_              | Target URL where error occurred            |
| `error_type`       | `VARCHAR(50)` | **NO**   | _None_              | Free-text error classification             |
