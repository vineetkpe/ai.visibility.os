...
| :--- | :--- | :--- | :--- | :--- |
| `id` | `UUID` | **NO** | `gen_random_uuid()` | Primary Key |
| `business_context_version_id` | `UUID` | **NO** | *None* | Foreign Key to `business_context_versions(id)` |
| `entity_type` | `entity_type` | **NO** | *None* | Entity category |
| `name` | `VARCHAR(255)` | **NO** | *None* | Entity name |
...
| `id` | `UUID` | **NO** | `gen_random_uuid()` | Primary Key |
| `business_context_version_id` | `UUID` | **NO** | *None* | Foreign Key to `business_context_versions(id)` |
| `name` | `VARCHAR(255)` | **NO** | *None* | Topic or keyword name |
...
| `id` | `UUID` | **NO** | `gen_random_uuid()` | Primary Key |
| `business_context_version_id` | `UUID` | **NO** | *None* | Foreign Key to `business_context_versions(id)` |
| `name` | `VARCHAR(255)` | **NO** | *None* | Service name |
...
| `name` | `VARCHAR(255)` | **NO** | *None* | Technology name |
