...
| `user_id` | `UUID` | **NO** | *None* | Foreign Key to `public.users(id)` |
| `name` | `VARCHAR(255)` | **NO** | *None* | Project display name |
| `slug` | `VARCHAR(255)` | **NO** | *None* | URL-friendly slug (unique per user) |
...
| `host` | `VARCHAR(255)` | **NO** | *None* | Normalized hostname (lowercase, no scheme/slash) |
