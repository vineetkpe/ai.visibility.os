...
import { DashboardPremiumClientView } from './dashboard-premium-client-view';

export const metadata = {
  title: 'Dashboard | AI Visibility OS',
  description: 'AI visibility intelligence, trends, evidence, and prioritized actions.',
};
...
export default async function DashboardPage({ searchParams }: PageProps) {
  ...
  return (
    <PageContainer title="" description="">
      <DashboardPremiumClientView projectId={project.id} initialData={initialData} />
    </PageContainer>
  );
}
