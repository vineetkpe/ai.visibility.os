...
export const metadata = {
  title: 'Overview | AI Visibility OS',
  description: 'Monitor AI visibility, scan health, competitors, and prioritized actions.',
};
...
export default async function DashboardPage({ searchParams }: PageProps) {
  ...
  return (
    <PageContainer
      title="Overview"
      description="See your latest AI visibility performance, scan health, competitors, and next actions."
    >
      <DashboardClientView
        projectId={project.id}
        initialData={overviewResult.success ? overviewResult.data : undefined}
      />
    </PageContainer>
  );
}
